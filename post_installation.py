...
def github_create_repo() -> None:
    body_json = {
        "name": "pynnacle",
        "description": "A utility class to simplify sending emails. ",
    }
...
def readthedocs_update() -> None:
    body_json = {"name": "pynnacle", "default_branch": "main"}
...
def main() -> None:
    ...
    file_path = r"\pynnacle\Lib\site-packages\semantic_release\repository.py"
