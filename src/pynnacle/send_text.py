...
sender = user_id
recipient = "stephen.jeffs2@gmail.com"
body = """Dear sir \n\nThis is another test"""
cc = [
    "zinc",
    "stephen.jeffs2@gmail.com",
    "stephen.ra.king@gmail.com",
    "junkmailcomplaints@gmail.com",
    "thesecuremailbox@gmail.com",
    "contact.sjeffs@gmail.com",
]
bcc = [
    "zinc",
]
attachments = [r"D:\PYTHON PROJECT\MY PROGS\EMAIL_TOOLS\NEW CLASS\files\cat.jpg"]
